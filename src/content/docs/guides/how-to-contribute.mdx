...
description: Learn how to contribute to the our wiki.
sidebar:
    order: 99
---
    ...
    <TabItem label="Locally">
      ...
      <Steps>
        ...
        2. Clone the repository:
            ```sh
            git clone https://github.com/tlmodding/tlmodding.github.io.git
            ```
        3. Navigate to the project directory:
            ```sh
            cd tlmodding.github.io
            ```
...
<ContributorList githubRepo="tlmodding/tlmodding.github.io" />