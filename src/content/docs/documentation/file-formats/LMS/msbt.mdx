...
`ATO1` defines which attributes to include from the defined structure in the [MSBP](/documentation/file-formats/lms/msbp)  file. This is useful to omit certain attributes that may not need to be displayed.
