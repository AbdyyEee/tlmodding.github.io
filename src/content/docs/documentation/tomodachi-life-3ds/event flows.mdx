...
`ToolBath_Build.msbt` is a [MSBT](/documentation/file-formats/lms/msbt) files store which relevant scene data as [Attributes](/documentation/file-formats/lms/msbt/#atr1). 
